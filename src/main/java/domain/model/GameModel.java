...
public class GameModel {
  ...
  @SuppressFBWarnings(value = "EI_EXPOSE_REP2",
      justification = "BoardHandler is shared; it is the single board state instance")
  ...
  /**
   * Moves the robber to the given hex and optionally steals from a victim.
   *
   * @param targetHexId the hex to move the robber to
   * @param victimColor the player to steal from, or null for no theft
   */
