...
public class PortTradeDialog {
  ...
  /**
   * Creates the port trade dialog.
   *
   * @param labels the localized label bundle
   * @param availablePorts the ports the current player may trade through
   */
  ...
  /** Shows the dialog and returns the user's port trade selection, if confirmed. */
