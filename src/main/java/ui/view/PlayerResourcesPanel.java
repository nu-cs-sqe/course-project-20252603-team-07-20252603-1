...
/** Grid panel showing all players' resource counts and victory points. */
...
public class PlayerResourcesPanel {
   ...
   *
   * @param controller the game-loop controller
  ...
  /** Re-reads resource counts and victory points from the model and redraws the grid. */
  public void refresh() {
