...
2. [90% done] Spencer: Continued work on graph
   class https://github.com/nu-cs-sqe/course-project-20252603-team-07-20252603-1/pull/24

- Worked on claiming nodes and edges
- Allow building of actual graph based on board layout

3. [done] Connor: Completed Player BVA based on PlantUML diagram + implemented associated
   tests. https://github.com/nu-cs-sqe/course-project-20252603-team-07-20252603-1/pull/29

- Added spotbug + checkstyle to project

4. [done] Kevin:  Initial views created https://github.com/nu-cs-sqe/course-project-20252603-team-07-20252603-1/pull/34

- Initialized the first round of views based on the initialization steps, branched out from Theo's PR.
...
3. Connor: Address checkstyle and spotbug issues, both in the player class, as well as across the repo
