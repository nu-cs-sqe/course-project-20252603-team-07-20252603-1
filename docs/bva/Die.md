...
Note: Catan always uses two dice numbered from 1 through 6, so for our purposes we will hardcode those values. We know
that these requirements will not change.
