...
|-------------|----------------------------------------------------------------|------------------------------------------------------------------------------|--------------|
| Test Case 1 | RED tries to claim node 0, which is free                       | RED now owns node 0, RED now in Hex city lists                               | x            |
...
|              | System under test                                                     | Expected output                                                                           | Implemented? |
|--------------|-----------------------------------------------------------------------|-------------------------------------------------------------------------------------------|--------------|
| Test Case 6  | RED tries to build a city on node 0, which they had a settlement on   | RED has a city on node 0, RED now in Hex city lists                                       | x            |
| Test Case 7  | BLUE tries to build a city on node 53, which they had a settlement on | BLUE has a city on node 53, BLUE now in Hex city lists                                    | x            |
