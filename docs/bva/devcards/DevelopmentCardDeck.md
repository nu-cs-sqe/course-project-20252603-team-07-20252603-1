...
|              | System under test                                        | Expected output                                                                          | Implemented? |
| ------------ | -------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ------------ |
| Test Case 7  | drawCard(3) from full deck (size 25)                     | card returned (non-null with valid type, roundDrawnAt == 3); countRemaining() is 24      | :x:          |
...
|              | System under test              | Expected output                              | Implemented? |
| ------------ | ------------------------------ | -------------------------------------------- | ------------ |
| Test Case 10 | shuffle() on full deck (25)    | card order is randomized; countRemaining() still 25 | :x:          |
