...
| ----------- | --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------------ |
| Test Case 1 | buyer has 1 ORE, 1 WOOL, 1 GRAIN (exact cost); deck full (25)                          | card returned; buyer loses 1 ORE, 1 WOOL, 1 GRAIN; card added to hand; deck countRemaining() is 24 | :x:          |
| Test Case 2 | buyer has 3 ORE, 2 WOOL, 4 GRAIN (surplus); deck full (25)                             | card returned; buyer's resources each decremented by 1; card added to hand                     | :x:          |
| Test Case 3 | buyer has 0 ORE, 1 WOOL, 1 GRAIN (insufficient ORE)                                    | IllegalStateException: "Not enough resources to buy a development card."                       | :x:          |
| Test Case 4 | buyer has 1 ORE, 0 WOOL, 1 GRAIN (insufficient WOOL)                                   | IllegalStateException: "Not enough resources to buy a development card."                       | :x:          |
| Test Case 5 | buyer has 1 ORE, 1 WOOL, 0 GRAIN (insufficient GRAIN)                                  | IllegalStateException: "Not enough resources to buy a development card."                       | :x:          |
| Test Case 6 | buyer has 1 ORE, 1 WOOL, 1 GRAIN; deck empty (0)                                       | EmptyDeckException: "Cannot draw new DevelopmentCard, no cards remain."                        | :x:          |
...
|              | System under test                                                                    | Expected output                                                             | Implemented? |
| ------------ | ------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- | ------------ |
| Test Case 8  | card = null                                                                          | IllegalArgumentException: "Development card cannot be null."                | :x:          |
...
| Test Case 20 | targetHexId valid, victim not adjacent to targetHexId                                 | IllegalArgumentException: "Victim must be adjacent to the robber's new hex." | :x:          |
...
|              | System under test                                                                  | Expected output                                                  | Implemented? |
| ------------ | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------- | ------------ |
| Test Case 21 | card = null                                                                        | IllegalArgumentException: "Development card cannot be null."     | :x:          |
| Test Case 22 | card type = KNIGHT (not MONOPOLY)                                                  | IllegalArgumentException: "Card is not a Monopoly card."         | :x:          |
| Test Case 23 | card drawn this round (not playable)                                               | IllegalStateException: "Card cannot be played the same turn it was purchased." | :x:          |
| Test Case 24 | player already played a dev card this turn                                         | IllegalStateException: "Already played a development card this turn." | :x:          |
...
| Test Case 43 | edge1 not connected to player's network, roads placed = 0                                  | IllegalArgumentException: "Road must connect to player's existing network." | :x:          |
| Test Case 44 | edge1 valid, edge2 is already occupied, roads placed = 0                                   | IllegalArgumentException: "Edge is already occupied."                       | :x:          |
...
| Test Case 50 | resource1 = null, resource2 = BRICK                                                      | IllegalArgumentException: "Resource cannot be null."                         | :x:          |
...
|              | System under test                                                    | Expected output | Implemented? |
| ------------ | -------------------------------------------------------------------- | --------------- | ------------ |
| Test Case 56 | hand is empty                                                        | 0               | :x:          |
| Test Case 57 | hand contains 1 VICTORY_POINT card only                              | 1               | :x:          |
| Test Case 58 | hand contains 3 KNIGHT and 2 VICTORY_POINT cards                     | 2               | :x:          |
| Test Case 59 | hand contains 5 VICTORY_POINT cards (maximum)                        | 5               | :x:          |
